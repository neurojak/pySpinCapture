...
EXPOSURE_TIME = 200 #in microseconds
...
FRAMES_TO_RECORD = 150000 #frame rate * num seconds to record; this should match # expected exposure triggers from DAQ counter output
...
movieName = groupStr + mouseStr + '.mp4'
